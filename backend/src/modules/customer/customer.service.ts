    ...
    return {
      ...
      data: {
        ...
        journey: latestApp ? {
          ...
          consentTexts,
          attribution: latestApp?.attribution ? {
            acquisitionSource: latestApp.attribution.acquisitionSource,
            utmSource: latestApp.attribution.utmSource,
            utmMedium: latestApp.attribution.utmMedium,
            utmCampaign: latestApp.attribution.utmCampaign,
            utmTerm: latestApp.attribution.utmTerm,
            utmContent: latestApp.attribution.utmContent,
            rmId: latestApp.attribution.rmId,
            rmName: latestApp.attribution.rmName,
            partnerCode: latestApp.attribution.partnerCode,
            partnerName: latestApp.attribution.partnerName,
            referralCode: latestApp.attribution.referralCode,
            capturedAt: latestApp.attribution.capturedAt,
          } : null,
        } : null,
        attribution: customer.attribution ? {
          id: customer.attribution.id.toString(),
          firstSource: customer.attribution.firstSource,
          firstUtmSource: customer.attribution.firstUtmSource,
          firstUtmMedium: customer.attribution.firstUtmMedium,
          firstUtmCampaign: customer.attribution.firstUtmCampaign,
          firstUtmTerm: customer.attribution.firstUtmTerm,
          firstUtmContent: customer.attribution.firstUtmContent,
          firstRmId: customer.attribution.firstRmId,
          firstRmName: customer.attribution.firstRmName,
          firstPartnerCode: customer.attribution.firstPartnerCode,
          firstPartnerName: customer.attribution.firstPartnerName,
          firstReferralCode: customer.attribution.firstReferralCode,
          firstTouchAt: customer.attribution.firstTouchAt,
          lastSource: customer.attribution.lastSource,
          lastUtmSource: customer.attribution.lastUtmSource,
          lastUtmMedium: customer.attribution.lastUtmMedium,
          lastUtmCampaign: customer.attribution.lastUtmCampaign,
          lastUtmTerm: customer.attribution.lastUtmTerm,
          lastUtmContent: customer.attribution.lastUtmContent,
          lastRmId: customer.attribution.lastRmId,
          lastRmName: customer.attribution.lastRmName,
          lastPartnerCode: customer.attribution.lastPartnerCode,
          lastPartnerName: customer.attribution.lastPartnerName,
          lastReferralCode: customer.attribution.lastReferralCode,
          lastTouchAt: customer.attribution.lastTouchAt,
        } : null,
      },
    };
  }
