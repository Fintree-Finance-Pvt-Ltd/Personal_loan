...
import { ChevronLeft, ChevronRight, Landmark, Plus, RefreshCw } from 'lucide-react';
...
function FilterSelect({
  ...
  return (
    <label className="block min-w-44 text-sm font-medium text-neutral-700">
      {label}

      <select
        value={value}
        onChange={onChange}
        className="mt-2 min-h-11 w-full rounded-xl border border-neutral-300 bg-white px-3.5 text-neutral-800 shadow-sm focus:border-brand-600"
      >
        {children}
      </select>
    </label>
    ...
    <>
        ...
        actions={
          <div className="flex flex-wrap gap-3">
            ...
            <PermissionGate permission="LENDER_CREATE">
              <Button as={Link} to="/admin-master/lenders/new">
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end">
          <label className="block flex-1 text-sm font-medium text-neutral-700">
            ...
            <input
              ...
              className="mt-2 min-h-11 w-full rounded-xl border border-neutral-300 bg-white px-3.5 text-neutral-900 shadow-sm placeholder:text-neutral-400 focus:border-brand-600"
            />
          </label>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="No lender matches the selected search and status filters."
          action={
            hasFilters && (
