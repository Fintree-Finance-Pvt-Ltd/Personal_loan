  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-neutral-950/45 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl" role="alertdialog" aria-modal="true">
        <h2 className="text-lg font-bold text-neutral-900">Disable user account?</h2>
        ...
        <label className="mt-5 flex items-center gap-2 cursor-pointer text-sm text-neutral-700">
          <input type="checkbox" checked={confirmed} onChange={e => setConfirmed(e.target.checked)} className="h-4 w-4 rounded border-neutral-300 text-danger-600" />
